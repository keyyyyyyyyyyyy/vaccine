		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sessacvaccine-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sessacvaccine-display": {
								"semanticObject": "sessacvaccine",
								"action": "display",
								"description": "백신접종 스케쥴",
								"title": "Vaccine Tracker",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sessac.vaccine",
									"url": sap.ui.require.toUrl("sessac/vaccine")
								}
							}
						}
					}
